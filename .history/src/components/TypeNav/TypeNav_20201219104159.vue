          ...
          <div class="sort">
            <div class="all-sort-list2">
              ...
              >
                <h3>
                  <!-- 一级分类名 -->
                  <a href="javascript:;" @click="toSearch({categoryName:CategoryItem.categoryName,category1Id:CategoryItem.categoryId})">{{ CategoryItem.categoryName }}</a>
                </h3>
                  ...
                  <div class="subitem">
                    ...
                    >
                      ...
                      <dd>
                        ...
                        >
                          <a href="javascript:;" @click="toSearch({categoryName:ChildChildItem.categoryName,category3Id:ChildChildItem.categoryId})">{{
...
export default {
  ...
  methods: {
    ...
    toSearch({categoryName="未找到",category1Id="未找到",category2Id="未找到",category3Id="未找到"}){
      this.$router.push({
        path:'/search',
        query:{
          categoryName,
