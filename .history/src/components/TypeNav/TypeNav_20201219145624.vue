    ...
    <div class="type-nav">
      <div class="container">
        <div @mouseleave="wrapLeave" @mouseenter="wrapEnter">
          <h2 class="all"  v-show="showOneLevel">全部商品分类</h2>
              ...
              >
                ...
                <div class="item-list clearfix">
                  <div class="subitem">
                    ...
                    >
                      <dt>
                        <a href="javascript:;" :data-category-name="ChildItem.categoryName" :data-category2-id="ChildItem.categoryId">{{ ChildItem.categoryName }}</a>
                      </dt>
                      <dd>
                        <!-- 三级分类 -->
                        <em
                        ...
                        >
                          <a href="javascript:;" :data-category-name="ChildChildItem.categoryName" :data-category3-id="ChildChildItem.categoryId">{{
...
export default {
  data() {
    return {
      currentIndex: -2,
      /* 是否显示一级列表项; */
      showOneLevel:['/','/home','/search'].includes(this.$route.path)
    };
  },
  methods: {
