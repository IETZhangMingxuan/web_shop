            ...
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                ...
                <li :class="{ active: options.order.split(':')[0] === `2` }">
                  <a href="javascript:;" style="display:flex;background:pink">价格<i class="icon-font icon-arrow-up"></i
                  ></a>
                </li>
                <li :class="{ active: options.order.split(':')[0] === `1` }">
                  <a href="javascript:;" style="display:flex;background:pink">价格<i class="icon-font icon-arrowdown"></i
                  ></a>
                </li>
              </ul>
            </div>
