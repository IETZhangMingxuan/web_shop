            ...
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                ...
                <li :class="{ active: options.order.split(':')[0] === `2` }">
                  <a href="javascript:;" style="display:flex;background:pink">价格<i class="icon-font icon-jiantou"></i
                  ></a>
                </li>
                <li :class="{ active: options.order.split(':')[0] === `1` }">
                  <a href="javascript:;" style="display:flex;background:pink">价格<i class="icon-font icon-jiantou-xia"></i
                  ></a>
                </li>
              </ul>
            </div>
