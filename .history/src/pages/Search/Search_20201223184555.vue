        ...
        <div class="details clearfix">
          <div class="sui-navbar">
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li >
                  <a href="javascript:;" :class="{active:options.order.split(':')[0] === 1}">综合</a>
                </li>
                <li>
                ...
                <li>
                  <a href="javascript:;" :class="{active:options.order.split(':')[0] === 2}">价格<i class="icon-font icon-arrow-up"></i></a>
                </li>
                <li>
